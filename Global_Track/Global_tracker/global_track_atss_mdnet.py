...
#
# __all__ = ['GlobalATSSTrack_MDNET']
#
#
# class GlobalATSSTrack_MDNET(Tracker):
#
...
#         name = 'GlobalATSSTrack_MDNET'
#         if name_suffix:
#             name += '_' + name_suffix
#         super(GlobalATSSTrack_MDNET, self).__init__(
