...
from logging_ import send_email
from voc_dataset_evaluator import evaluate_boxes_fsod
...
def evaluate_boxes(dataset, all_boxes, output_dir, use_matlab=False):
    ...
    voc_eval = evaluate_boxes_fsod(
        dataset, all_boxes, output_dir, use_matlab=use_matlab)  # fix to use for fsod
